...
const arr = ["Basics", "Searching and Sorting", "Arrays and Hashing", "Strings", "Sets and Hashmap", "Binary Search", "Two Pointers", "Prefix Sum", "Linked List", "Sliding Window", "Stack", "Queue", "Backtracking", "Trees", "Dynamic Programming", "Priority Queue/Heap", "Graphs", "Tries", "Greedy", "Bit Manipulation"];
